...
module.exports = { 
    ...
    "rules": {
        ...
        "selector-class-pattern": [
            ...
            {
                "message": "class name MUST be Lite BEM: `.ComponentName-descendentName_modifierName`,`utilityName-propertyName`,`.is-stateOfComponent` or `.has-propertyOfComponent`精简版BEM",

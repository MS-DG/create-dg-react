...
function init() {
  const program = new commander.Command(packageJson.name)
    ...
    .on('--help', () => {
      ...
      console.log(
        `      ${chalk.cyan(
          'https://github.com/MS-DG/create-dg-react/issues/new'
        )}`
      );
      console.log();
    })
      ...
      .run(
        {
          ...
          npmPackages: ['react', 'react-dom', '@dragongate/react-scripts'],
          npmGlobalPackages: ['create-dg-react'],
        },
        {
          duplicates: true,
          showNotFound: true,
...
function checkForLatestVersion() {
  return new Promise((resolve, reject) => {
    https
      .get(
        'https://registry.npmjs.org/-/package/create-dg-react/dist-tags',
        res => {
